...
#导入模型
with open('xgbrbest-2 Split.pickle', 'rb') as f:
    model_loaded = pickle.load(f)


# 导入验证数据
data_verify = pd.read_csv(r"RAFM-dataset - verify.csv", encoding ='gb2312')

#导入原始数据
data_raw = pd.read_csv(r"xgbrbest-2 Split.csv", encoding ='gb2312')
